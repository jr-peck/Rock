...
{
    /// <summary>
    /// Calls <see cref="IRockContentLibraryIndexable.IndexContentLibraryDocument(int)"/> for the specified <see cref="IEntity"/>
    /// </summary>
    public sealed class ProcessContentLibraryDocument : BusStartedTask<ProcessContentLibraryDocument.Message>
    {
        /// <summary>
        ...
        public override void Execute( Message message )
        {
            ...
            {
                indexable.IndexContentLibraryDocument( message.EntityId );
            }
        }
