...
import { DataViewsPickerGetDataViewsOptionsBag } from "@Obsidian/ViewModels/Rest/Controls/dataViewsPickerGetDataViewsOptionsBag";
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const loadOptions = async (): Promise<ListItemBag[]> => {
            const options: Partial<DataViewsPickerGetDataViewsOptionsBag> = {
                securityGrantToken: securityGrantToken.value,
                entityTypeGuid: props.entityTypeGuid
            };
            const url = "/api/v2/Controls/DataViewsPickerGetDataViews";
